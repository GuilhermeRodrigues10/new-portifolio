              ...
              <CardColumns>
                ...
                <FadeIn delay={350}>
                  <Card>
                    <Card.Body>
                      <Card.Text>
                        Resido em São Carlos/SP e algumas dessas fotos foram
                        tiradas em visitas à cidades vizinhas. Tirar fotos da
                        natureza é uma das minhas atividades favoritas!
                      </Card.Text>
                    </Card.Body>
                  </Card>
                </FadeIn>
